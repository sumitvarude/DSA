...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_checks_weather_queue_is_full_12");
	setup();
		test_checks_weather_queue_is_full_12();
	tearDown();
	testEnded();
	testStarted("test_checks_weather_queue_is_not_full_13");
	setup();
		test_checks_weather_queue_is_not_full_13();
	tearDown();
	testEnded();
	testStarted("test_checks_weather_queue_is_empty_14");
	setup();
		test_checks_weather_queue_is_empty_14();
	tearDown();
	testEnded();
	testStarted("test_checks_weather_queue_is_not_empty_15");
	setup();
		test_checks_weather_queue_is_not_empty_15();
	tearDown();
	testEnded();
	testStarted("test_gives_rare_element_of_queue_as_a_integer_16");
	setup();
		test_gives_rare_element_of_queue_as_a_integer_16();
	tearDown();
	testEnded();
	...
	tearDown();
	testEnded();
	testStarted("test_gives_rare_element_of_queue_as_a_String_18");
	setup();
		test_gives_rare_element_of_queue_as_a_String_18();
	tearDown();
	testEnded();
