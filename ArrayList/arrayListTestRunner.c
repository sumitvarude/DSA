...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_add_element_at_end_of_arrayList");
	setup();
		test_add_element_at_end_of_arrayList();
	tearDown();
	testEnded();
	testStarted("test_removes_element_from_given_index");
	setup();
		test_removes_element_from_given_index();
	tearDown();
	testEnded();
	testStarted("test_should_not_remove_element_from_empty_array");
	setup();
		test_should_not_remove_element_from_empty_array();
	tearDown();
	testEnded();
	testStarted("test_gives_index_of_element_if_found");
	setup();
		test_gives_index_of_element_if_found();
	tearDown();
	testEnded();
	testStarted("test_gives_minus_1_if_arrayList_is_empty");
	setup();
		test_gives_minus_1_if_arrayList_is_empty();
	tearDown();
	testEnded();
	testStarted("test_gives_minus_1_if_not_found");
	setup();
		test_gives_minus_1_if_not_found();
	tearDown();
	testEnded();
